...
export function Navbar() {
  ...
  return (
    ...
    >
      <nav className="mx-auto flex h-16 max-w-7xl items-center px-4 sm:px-6 md:h-20 lg:px-8">
        {/* Logo + name */}
        <button
          onClick={() => go("home")}
        ...
        {/* Desktop nav */}
        <div className="hidden ml-auto items-center justify-end gap-1 lg:flex">
          {navItems.map((item) => {
